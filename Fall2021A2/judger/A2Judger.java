...
public class A2Judger {
    ...
    public void test() throws Throwable {
        for (int i = 4; i <= 4; i++) {
            String className = "Fall2021A2.A2Q"+i;
            for (int j = 1; j <= 20; j++) {
                ...
                String inName = "src\\Fall2021A2\\data\\data"+i+"\\"+j+".in";
                String outName = "src\\Fall2021A2\\data\\data"+i+"\\"+j+".out";
