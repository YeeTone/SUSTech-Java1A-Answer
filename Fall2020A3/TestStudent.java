...
public class TestStudent {
    ...
    void test1() throws Exception {
        String[] fieldsExpected = {"private java.lang.String Student.name"};
    ...
    void test2() throws Exception {
        String[] fieldsExpected = {"private int Student.sid"};
        String[] methodsExpected = {"public int Student.getSid()"};
        String[] methodsUnexpected = {"public void Student.setSid(int)"};
    ...
    void test3() throws Exception {
        String[] fieldsExpected = {"private static int Student.studentCnt"};
        String[] methodsExpected = {"public static int Student.getStudentCnt()"};
        Utils.checkClass(studentClass, fieldsExpected, methodsExpected);
    }
    ...
    void test4() throws Exception {
        String[] fieldsExpected = {
                ...
                "private int Student.sid",
                "private static int Student.studentCnt"
        };
        String[] methodsExpected = {
                "public java.lang.String Student.getName()",
                "public java.lang.String Student.toString()",
                "public void Student.setName(java.lang.String)",
                "public static int Student.getStudentCnt()",
