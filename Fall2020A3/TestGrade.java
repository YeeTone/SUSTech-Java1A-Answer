...
public class TestGrade {
    ...
    static void beforeAll() {
        try {
            gradeClass = Class.forName("Fall2020A3.Grade");
    ...
    void test01() throws Exception {
        String[] fieldsExpected = {"private Fall2020A3.Course Fall2020A3.Grade.course"};
        String[] methodsExpected = {"public Fall2020A3.Course Fall2020A3.Grade.getCourse()"};
        String[] methodsUnexpected = {"public void Fall2020A3.Grade.setCourse(Course)"};
    ...
    void test02() throws Exception {
        String[] fieldsExpected = {"private Fall2020A3.Student Fall2020A3.Grade.student"};
        String[] methodsExpected = {"public Fall2020A3.Student Fall2020A3.Grade.getStudent()"};
        String[] methodsUnexpected = {"public void Fall2020A3.Grade.setStudent(Student)"};
        Utils.checkClass(gradeClass, fieldsExpected, methodsExpected, methodsUnexpected);
    }
    ...
    void test03() throws Exception {
        String[] fieldsExpected = {"private float Fall2020A3.Grade.grade"};
        String[] methodsExpected = {
                "public float Fall2020A3.Grade.getGrade()",
                "public void Fall2020A3.Grade.setGrade(float)"
        };
    ...
    void test04() throws Exception {
        String[] fieldsExpected = {"private float Fall2020A3.Grade.gpa"};
        String[] methodsExpected = {"public float Fall2020A3.Grade.getGpa()"};
        String[] methodsUnexpected = {"public void Fall2020A3.Grade.setGpa(float)"};
        Utils.checkClass(gradeClass, fieldsExpected, methodsExpected, methodsUnexpected);
    }
    ...
    void test05() throws Exception {
        ...
        String[] methodsExpected = {"public java.lang.String Fall2020A3.Grade.toString()"};
        Utils.checkClass(gradeClass, fieldsExpected, methodsExpected);
    ...
    void test06() throws Exception {
        String[] fieldsExpected = {};
        String[] methodsExpected = {"public static float Fall2020A3.Grade.calGpa(float)"};
        Utils.checkClass(gradeClass, fieldsExpected, methodsExpected);
    }
