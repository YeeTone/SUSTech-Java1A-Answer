...
public class LocalTestcasesGenerator {
    public static void main(String[] args) throws Throwable {
        ...
        int[] casesNumbers = {5, 6, 8, 12, 16, 20, 25, 30, 36, 42};

        for (int i = 11; i <= 30; i++) {
            Set<String> nodes = generateNodes(nodeNumbers[(i - 1) % 10]);
            String[][] testcases = generateFlights(casesNumbers[(i - 1) % 10], nodes);
